...
export default function AuthLayout({
  ...
  children: React.ReactNode;
    ...
    return (
        <div id="signPage" className="flex bg-white h-[100vh] w-[100vw] box-border justify-between">
            <div id="signPage__left" className="">
                ...
                <div id="signPage__left__form" className=" h-[461px] mt-[89px] w-[374px] ml-[140px]">
                    {children}
                </div>
            </div>
