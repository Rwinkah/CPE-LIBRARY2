        ...
        return (
            <Form {...form}>
                <form
                    ...
                    className="space-y-8"
                >
                    <h3 className="flex"> <span className=" block bg-[#820B8A] h-2 mt-2 mr-2 w-2 rounded-3xl"/>Step 1 of 3</h3>
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input className="focus:outline-none rounded-3xl" placeholder="student-lastname@eng.uniben.edu" {...field}/>
                                </FormControl>
                            </FormItem>
                        )}
                    />
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input className=" focus:outline-none rounded-3xl" placeholder="**********" type="password" {...field} />
                                </FormControl>
                            </FormItem>
                        )}

                    />
                    <h3 className="font-normal text-sm"> <Checkbox id="terms" className="mr-2" checked={isChecked} onClick={(e) => { setIsChecked(!isChecked) }} /> I agree to the <a  className='underline' href="">Terms & Privacy</a></h3>
                    <Button disabled={isChecked === true ? false : true} className="rounded-3xl border w-[100%] bg-[#820B8A] text-white"type="submit" onClick={onProceed}>Submit</Button>
        ...
        return (
            <Form {...form}>
                <form
                    ...
                    className="space-y-8"
                >
                    <h3 onClick={()=> setStep(1)} className="flex"> <Image src={arrow} className="h-2 w-1.5 mt-2 mr-4" alt="back-arrow"/> Step 2 of 3</h3>
                    <h1 className="text-4xl font-bold">Create an account</h1>
                    <div className="flex justify-between gap-4">
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input className="focus:outline-none rounded-3xl" placeholder="Osato" {...field}/>
                                </FormControl>
                            </FormItem>
                        )}
                    />
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                   ...
                                   <select className=" pl-4 w-[100%] h-[48px] focus:outline-none border-grey border rounded-3xl"  name="firstSem" id="firstSem placeholder='select courses'">
        ...
        return (
            <Form {...form}>
                <form
                    ...
                    className="space-y-8"
                >
                    <h3 onClick={()=> setStep(1)} className="flex"> <Image src={arrow} className="h-2 w-1.5 mt-2 mr-4" alt="back-arrow"/> Step 3 of 3</h3>
                    <h1 className="text-4xl font-bold">Create an account</h1>
                    <FormField
                        control={form.control}
                        name="firstSem"
                            ...
                            <FormItem>
                                ...
                                <FormControl>
                                   ...
                                   {/* <select className=" pl-4 w-[100%] h-[48px] focus:outline-none border-grey border rounded-3xl"  name="level" id="level">
                                    ...
                                    <SelectCourse course={firstS} setCourse={setFirstS} courseList={courseListFirst} />
                                </FormControl>
                                    {firstS && (
                            ...
                            <FormItem>
                                ...
                                <FormControl>
                                   ...
                                   {/* <select className=" pl-4 w-[100%] h-[48px] focus:outline-none border-grey border rounded-3xl"  name="level" id="level">
                                    ...
                                    <SelectCourse course={secondS} courseList={courseListSecond} setCourse={setSecondS} />
                                </FormControl>
                                {secondS && (
                                    <div className="flex flex-wrap w-[100%] gap-1">
                                        {secondS.map((value, index) => (
                                            <Button
                                                ...
                                                <Image
                                                    src={close}
                                                    alt="close"
                                                    onClick={() => handleRemove(index, setSecondS, secondS)}
                                                />
                                        </Button>
                                        ))}
                                    </div>
