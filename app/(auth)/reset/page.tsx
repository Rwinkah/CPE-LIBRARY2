...
export default function PasswordReset() {
    return (
            ...
            <div id="resetPage__form" className=" h-[461px] mt-[89px] w-[374px] self-center">
                <h1 className='text-[40px] font-bold mb-[8px]'>Reset Password</h1>
                    <h4 className='mb-[56px]'>osato.omorodion@eng.uniben.edu type in your new password for reset</h4>
                    <ResetForm />
                </div>
            </div>
    )
